...
//        }
    ...
    @ResponseBody
    public ServerResponse<PageInfo> productSearch(String productName,Integer productId,@RequestParam(value = "pageNum",defaultValue = "1") Integer pageNum, @RequestParam(value = "pageSize",defaultValue = "10")Integer pageSize){
//        String loginToken = CookieUtil.readLoginToken(servletRequest);
//        if(StringUtils.isEmpty(loginToken)){
//            return ServerResponse.createErrorMessageResponse("用户未登录,无法获取当前用户的信息");
//        }
...
//        }
    ...
    @ResponseBody
    public ServerResponse<Map> upload(@RequestParam(value = "upload_file",required = false) MultipartFile file, HttpServletRequest request){
//        String loginToken = CookieUtil.readLoginToken(servletRequest);
//        if(StringUtils.isEmpty(loginToken)){
//            return ServerResponse.createErrorMessageResponse("用户未登录,无法获取当前用户的信息");
//        }
